    ...
    <div className='space-y-8'>
      ...
      {activeTab === 'documents' ? (
        ...
        <>
                    ...
                    <tr className='bg-dark-elevated border-b border-dark-border'>
                      <th className='py-4 px-6 text-left'>
                        <SortButton
                          ...
                          direction={
                            sortBy === 'fullname' ? (sortDirection.toLowerCase() as 'asc' | 'desc') : undefined
                          }
                      ...
                      <th className='py-4 px-6 text-center'>
                        <SortButton
                          ...
                          direction={
                            sortBy === 'totalproducts' ? (sortDirection.toLowerCase() as 'asc' | 'desc') : undefined
                          }
                      ...
                      <th className='py-4 px-6 text-center'>
                        <SortButton
                          ...
                          direction={
                            sortBy === 'activeproducts' ? (sortDirection.toLowerCase() as 'asc' | 'desc') : undefined
                          }
                      ...
                      <th className='py-4 px-6 text-center'>
                        <SortButton
                          ...
                          direction={
                            sortBy === 'totalsoldcount' ? (sortDirection.toLowerCase() as 'asc' | 'desc') : undefined
                          }
                      ...
                      <th className='py-4 px-6 text-left'>
                        <SortButton
                          ...
                          direction={
                            sortBy === 'createddate' ? (sortDirection.toLowerCase() as 'asc' | 'desc') : undefined
                          }
          ...
          <CreateSignupLinkModal isOpen={isSignupModalOpen} onClose={() => setIsSignupModalOpen(false)} />
